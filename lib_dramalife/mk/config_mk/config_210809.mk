...
# Update : 2021/08/09, Move "_DL_88888888_LIB_ENABLE_" to config_lib_dramalife.h;
################################################################################
# Header Files` Path
CFLAGS+=-I$(PATH_ABS)
...
# MACRO "_DL_88888888_LIB_ENABLE_" should placed in config_lib_dramalife.h
...
#  MACRO "_DL_88888888_DEBUG_ENABLE_" should placed in config_lib_dramalife.h
