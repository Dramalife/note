...
# 245 "/usr/include/arm-linux-gnueabihf/bits/siginfo.h" 3 4
enum
{
  CLD_EXITED = 1,
...
# 297 "/usr/include/arm-linux-gnueabihf/bits/siginfo.h" 3 4
...
# 21 "/usr/include/arm-linux-gnueabihf/bits/pthreadtypes.h" 3 4
...
# 86 "/usr/include/arm-linux-gnueabihf/sys/types.h" 3 4
...
# 45 "/usr/include/arm-linux-gnueabihf/sys/select.h" 3 4
# 1 "/usr/include/time.h" 1 3 4
...
# 237 "/usr/include/arm-linux-gnueabihf/sys/stat.h" 3 4
extern int fstatat (int __fd, const char *__restrict __file,
      struct stat *__restrict __buf, int __flag)
     __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__nonnull__ (2, 3)));
# 262 "/usr/include/arm-linux-gnueabihf/sys/stat.h" 3 4
extern int lstat (const char *__restrict __file,
    struct stat *__restrict __buf) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__nonnull__ (1, 2)));
# 283 "/usr/include/arm-linux-gnueabihf/sys/stat.h" 3 4
...
# 320 "/usr/include/arm-linux-gnueabihf/sys/stat.h" 3 4
...
# 441 "/usr/include/arm-linux-gnueabihf/sys/stat.h" 3 4
...
# 533 "/usr/include/arm-linux-gnueabihf/sys/stat.h" 3 4
...
# 363 "/usr/include/arm-linux-gnueabihf/bits/fcntl-linux.h" 3 4

# 437 "/usr/include/arm-linux-gnueabihf/bits/fcntl-linux.h" 3 4
...
# 1 "../lib/error_functions.h" 1
# 22 "../lib/error_functions.h"
void errMsg(const char *format, ...);
# 35 "../lib/error_functions.h"
void errExit(const char *format, ...) __attribute__ ((__noreturn__)) ;

void err_exit(const char *format, ...) __attribute__ ((__noreturn__)) ;

void errExitEN(int errnum, const char *format, ...) __attribute__ ((__noreturn__)) ;

void fatal(const char *format, ...) __attribute__ ((__noreturn__)) ;

void usageErr(const char *format, ...) __attribute__ ((__noreturn__)) ;

void cmdLineErr(const char *format, ...) __attribute__ ((__noreturn__)) ;
# 33 "../lib/tlpi_hdr.h" 2
# 45 "../lib/tlpi_hdr.h"
...
# 33 "fifo_seqnum_server.c" 2

int
main(int argc, char *argv[])
{
    int serverFd, dummyFd, clientFd;
    char clientFifo[(sizeof("/tmp/seqnum_cl.%ld") + 20)];
    struct request req;
    ...
    umask(0);
    if (mkfifo("/tmp/seqnum_sv", 
# 46 "fifo_seqnum_server.c" 3 4
                           0400 
# 46 "fifo_seqnum_server.c"
                                   | 
# 46 "fifo_seqnum_server.c" 3 4
                                     0200 
# 46 "fifo_seqnum_server.c"
...
# 46 "fifo_seqnum_server.c"
            ...
            && 
# 47 "fifo_seqnum_server.c" 3 4
              (*__errno_location ()) 
# 47 "fifo_seqnum_server.c"
                    != 
# 47 "fifo_seqnum_server.c" 3 4
                       17
# 47 "fifo_seqnum_server.c"
                             )
        errExit("mkfifo %s", "/tmp/seqnum_sv");
    serverFd = open("/tmp/seqnum_sv", 
# 49 "fifo_seqnum_server.c" 3 4
                                00
# 49 "fifo_seqnum_server.c"
                                        );
    if (serverFd == -1)
        errExit("open %s", "/tmp/seqnum_sv");



    dummyFd = open("/tmp/seqnum_sv", 
# 55 "fifo_seqnum_server.c" 3 4
                               01
# 55 "fifo_seqnum_server.c"
                                       );
    if (dummyFd == -1)
        errExit("open %s", "/tmp/seqnum_sv");
    ...
    if (signal(
# 61 "fifo_seqnum_server.c" 3 4
              13
# 61 "fifo_seqnum_server.c"
                     , 
# 61 "fifo_seqnum_server.c" 3 4
                       ((__sighandler_t) 1)
# 61 "fifo_seqnum_server.c"
...
# 61 "fifo_seqnum_server.c"
    ...
    for (;;) {
        if (read(serverFd, &req, sizeof(struct request))
            ...
            fprintf(
# 66 "fifo_seqnum_server.c" 3 4
                   stderr
# 66 "fifo_seqnum_server.c"
        ...
        snprintf(clientFifo, (sizeof("/tmp/seqnum_cl.%ld") + 20), "/tmp/seqnum_cl.%ld",
                (long) req.pid);
        clientFd = open(clientFifo, 
# 74 "fifo_seqnum_server.c" 3 4
                                   01
# 74 "fifo_seqnum_server.c"
                                           );
        if (clientFd == -1) {
        ...
        if (write(clientFd, &resp, sizeof(struct response))
            ...
            fprintf(
# 85 "fifo_seqnum_server.c" 3 4
                   stderr
# 85 "fifo_seqnum_server.c"
                         , "Error writing to FIFO %s\n", clientFifo);
        if (close(clientFd) == -1)
            errMsg("close");
